...
public class ReportsPage extends TestBase {
    ...
    WebElement casesByUsersReportLink ;

    @FindBy (xpath = "//td[contains(text(),'Open cases: by user')]")
    public WebElement casesByUsersReportVerifyLink ;

    @FindBy (xpath = "//a[contains(text(),'Cases Open by Users')]")
    WebElement casesOpenByUsersReportLink ;

    @FindBy (xpath = "//td[contains(text(),'Open cases: by user')]")
    public WebElement casesOpenByUsersReportVerifyLink ;

    @FindBy (xpath = "//a[contains(text(),'Cases and Companies')]")
    WebElement casesAndCompaniesReportLink ;

    @FindBy (xpath = "//td[contains(text(),'Report: Cases by Company ')]")
    public WebElement casesAndCompaniesReportVerifyLink ;

    @FindBy (xpath = "//a[contains(text(),'Company Statistics')]")
    WebElement companyStatisticsReportLink ;
    ...
    @FindBy (xpath = "//a[contains(text(),'Company Counts by Users')]")
    WebElement companyCountsByUsersReportLink ;

    @FindBy (xpath = "//td[contains(text(),'Report: Companies created by users')]")
    public WebElement companyCountsByUsersReportVerifyLink ;

    @FindBy (xpath = "//a[contains(text(),'Company Categories')]")
    WebElement companyCategoriesReportLink ;

    @FindBy (xpath = "//td[contains(text(),'Report: Company Categories')]")
    public WebElement companyCategoriesReportVerifyLink ;
    ...
    public void casesByUsersReport() throws InterruptedException {
        Thread.sleep(2000);
        casesByUsersReportLink.click();
    }

    public void casesOpenByUsersReport() throws InterruptedException {
         Thread.sleep(2000);
         casesOpenByUsersReportLink.click();
    }

    public void casesAndCompaniesReport() throws InterruptedException {
         Thread.sleep(2000);
         casesAndCompaniesReportLink.click();
    }
    ...
    public void companyCountsByUsersReport() throws InterruptedException {
         Thread.sleep(2000);
         companyCountsByUsersReportLink.click();
    }

    public void companyCategoriesReport() throws InterruptedException {
         Thread.sleep(2000);
         companyCategoriesReportLink.click();
    }
